  ...
  <section class="relative">
    <div class="max-w-7xl mx-auto px-10 pb-8 text-center">
      ...
      <div
        ...
        <a @click="nextSlide" class="btn btn-circle bg-[#75200D] text-white rounded-full px-2 py-2">
          ❯
        </a>
      </div>
    </div>
...
const packages = [
  {
    ...
    description: "Deskripsi lengkap tentang Paket Sekolah. Paket ini cocok untuk kegiatan sekolah dengan pilihan menu variatif.",
  },
  {
    title: "Prasmanan",
    image: "/src/assets/imagesambelgoreng.png",
    price: "Mulai dari 15.000 / Porsi",
    description: "Paket prasmanan untuk acara dengan berbagai pilihan makanan, cocok untuk acara pernikahan, rapat, dll.",
  },
  {
    title: "Kantor",
    image: "/src/assets/imagenasiliwet.png",
    price: "Mulai dari 15.000 / Porsi",
    description: "Paket untuk makan siang di kantor dengan menu praktis dan bergizi, pas untuk kegiatan kantor.",
  },
];
